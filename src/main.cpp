...
static const PROGMEM u1_t NWKSKEY[16] = {0x93, 0x8B, 0x8B, 0x58, 0x1A, 0x08, 0x54, 0xB5,
                                         0x24, 0xA1, 0xBD, 0x18, 0xCC, 0x89, 0xA3, 0x9D};

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the prototype TTN network initially.
static const u1_t PROGMEM APPSKEY[16] = {0x07, 0x93, 0x9D, 0xBD, 0xBF, 0xF5, 0xEF, 0xFE,
                                         0xE8, 0x89, 0xDC, 0x60, 0xDB, 0xF2, 0x0B, 0x49};

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x26021B13;
...
void GPSWrite()
{
    ...
    if (flon != 1000.000000)
    {
        ...
        // the format of datasend is longtitude,latitude,altitude
        //strcpy(datasend, String(gps_lon).c_str());
